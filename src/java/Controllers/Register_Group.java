 ...
 * @author Stuart
 */
@WebServlet(name = "Register_Group", urlPatterns = {"/Register_Group"})
public class Register_Group extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Group newGroup = new Group(group_name, current.getUsername());
            
            //Register this group to the database
            database.registerGroup(newGroup);
