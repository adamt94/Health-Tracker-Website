 ...
 * @author Stuart
 */
@WebServlet(name = "AddCustomSustenance", urlPatterns = {"/AddCustomSustenance"})
public class AddCustomSustenance extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Sustenance s = new Sustenance(name);
            s.setCreatedBy(username);
            database.addCustomSustenance(s);
