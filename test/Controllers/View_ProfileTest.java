...
public class View_ProfileTest {
    ...
    //When a user makes an invalid login, it's expected that they will
    ...
    public void testInvalidLogIn() throws Exception {
        ...
        //
        //Test that the log_in servlet redirects to index.jsp when given incorrect details
        //
        
        //When instance attemps to validate user, return false
        when(instance.database.validateUser("test1", "test1")).thenReturn(false);
        instance.processRequest(mockRequest, mockResponse);

        //Verify there was a redirect to index.jsp as expected
